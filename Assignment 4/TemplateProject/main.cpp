/*
 ...
 Combining HDR Toning and LookUp Table
...
GLuint frameBuffer, frameBufferTexture, frameBufferUniformLocation;
...
void display(void) {
    ...
    glUniform3f(lightColorUniform0, 0.8, 0.3, 10.0);
    glUniform3f(specularLightUniform0, 1.0, 0.5, 1.0);
...
void init() {
    ...
    glBindTexture(GL_TEXTURE_2D, frameBufferTexture);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F_ARB, 750, 750, 0, GL_RGB, GL_FLOAT, NULL);
    ...
    // Normal, diffuse, specular textures
